...
def validate_facebook_profile(value):
    if "www.facebook.com/" in value:
        return value
    else:
        raise ValidationError(
            "Vous devez entrer un lien vers votre profile Facebook")

def validate_twitter_profile(value):
    if "twitter.com/" in value:
        return value
    else:
        raise ValidationError(
            "Vous devez entrer un lien vers votre profile Twitter")

def validate_instagram_profile(value):
    if "www.instagram.com/" in value:
        return value
    else:
        raise ValidationError(
            "Vous devez entrer un lien vers votre profile Instagram")
...
def validate_github_profile(value):
    if "github.com/" in value:
        ...
        raise ValidationError(
            "Vous devez entrer un lien vers votre profile Github")

def validate_linkedin_profile(value):
    if "www.linkedin.com/in/" in value:
        return value
    else:
        raise ValidationError(
            "Vous devez entrer un lien vers votre profile Linkedin")
...
class Section(models.Model):
    ...
    class Meta:
        verbose_name_plural = '01.Sections'
    ...
    profile = models.ForeignKey('UserProfile', on_delete=models.CASCADE,verbose_name='Profile')
    name = models.CharField(max_length=50, choices=SECTION_CHOICES,verbose_name='Nom')
    description = models.CharField(max_length=500, blank=True, null=True,verbose_name='Decription')
...
class I_Am (models.Model):
    
    class Meta:
        verbose_name_plural = '03.Portraits '
        verbose_name = 'Portrait'

    profile = models.ForeignKey('UserProfile', on_delete=models.CASCADE,verbose_name='Profile')
    i_am = models.CharField(max_length=50,verbose_name='Je suis:')
...
class UserProfile(models.Model):
    ...
    class Meta:
        verbose_name_plural = '02.Profiles utilisateurs'
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE, primary_key=True,verbose_name='Utilisateur')
    ...
    gender = models.CharField(max_length=10, default='Male', choices=GENDER_CHOICES,verbose_name='Genre')
    location = models.CharField(max_length=30, blank=True,verbose_name='Adresse')
    email = models.EmailField(unique=True,verbose_name='Email')
    phone = models.CharField(max_length=30, blank=True,verbose_name='Téléphone')
    facebook = models.CharField(max_length=200, null=True, blank=True, validators=[validate_facebook_profile],verbose_name='Facebook')
    twitter = models.CharField(max_length=200, null=True, blank=True, validators=[validate_twitter_profile],verbose_name='Twitter')
    instagram = models.CharField(max_length=200, null=True, blank=True, validators=[validate_instagram_profile],verbose_name='Instagram')
    github = models.CharField(max_length=200, null=True, blank=True, validators=[validate_github_profile],verbose_name='Github')
    linkedin = models.CharField(max_length=200, null=True, blank=True, validators=[validate_linkedin_profile],verbose_name='Linkedin')

    def rename_upload_avatar(instance, filename):
        filebase, extension = filename.split('.')
        return 'avatar\\'+f'{instance.user.username}.{extension}'
        
    avatar = models.ImageField(blank=True, upload_to=rename_upload_avatar,default='avatar/default_avatar.jpg',verbose_name='Avatar')
    title = models.CharField(max_length=200, blank=True, null=True,verbose_name='Titre')
    degree = models.CharField(max_length=200, blank=True, null=True,verbose_name='Diplôme')
    ...
    def rename_upload_file(instance, filename):
        filebase, extension = filename.split('.')
        return 'cv users\\'+f'{instance.user.username}' + '.' + f'{extension}'

    cv = models.FileField(blank=True, null=True, upload_to=rename_upload_file,verbose_name='Fichier CV')

    def __str__(self):
        return f'{self.first_name}' + ' ' + f'{self.last_name}'

    def rename_upload_bg_wallpaper(instance, filename):
        filebase, extension = filename.split('.')
        return 'bg_wallpaper\\'+f'{instance.user.username}.{extension}'

    bg_wallpaper = models.ImageField(
        blank=True, null=True, upload_to=rename_upload_bg_wallpaper,default='bg_wallpaper/default_bg.jpg',verbose_name='Bannière')
 
# Fact ===========================================================
class Fact(models.Model):

    class Meta:
        verbose_name_plural = '04.Faits'
        verbose_name = 'Fait'
        ordering = ["name"]
    ...
    ICONEB_CHOICES = (
        ...
        ('1-circle-1', '1-circle-1'),
        ('1-circle-fill-1', '1-circle-fill-1'),
        ('1-circle-fill', '1-circle-fill'),
        ('1-circle', '1-circle'),
        ('1-square-fill', '1-square-fill'),
        ('1-square', '1-square'),
        ('2-circle-1', '2-circle-1'),
        ('2-circle-fill-1', '2-circle-fill-1'),
        ('2-circle-fill', '2-circle-fill'),
        ('2-circle', '2-circle'),
        ('2-square-fill', '2-square-fill'),
        ('2-square', '2-square'),
        ('3-circle-1', '3-circle-1'),
        ('3-circle-fill-1', '3-circle-fill-1'),
        ('3-circle-fill', '3-circle-fill'),
        ('3-circle', '3-circle'),
        ('3-square-fill', '3-square-fill'),
        ('3-square', '3-square'),
        ('4-circle-1', '4-circle-1'),
        ('4-circle-fill-1', '4-circle-fill-1'),
        ('4-circle-fill', '4-circle-fill'),
        ('4-circle', '4-circle'),
        ('4-square-fill', '4-square-fill'),
        ('4-square', '4-square'),
        ('5-circle-1', '5-circle-1'),
        ('5-circle-fill-1', '5-circle-fill-1'),
        ('5-circle-fill', '5-circle-fill'),
        ('5-circle', '5-circle'),
        ('5-square-fill', '5-square-fill'),
        ('5-square', '5-square'),
        ('6-circle-1', '6-circle-1'),
        ('6-circle-fill-1', '6-circle-fill-1'),
        ('6-circle-fill', '6-circle-fill'),
        ('6-circle', '6-circle'),
        ('6-square-fill', '6-square-fill'),
        ('6-square', '6-square'),
        ('7-circle-1', '7-circle-1'),
        ('7-circle-fill-1', '7-circle-fill-1'),
        ('7-circle-fill', '7-circle-fill'),
        ('7-circle', '7-circle'),
        ('7-square-fill', '7-square-fill'),
        ('7-square', '7-square'),
        ('8-circle-1', '8-circle-1'),
        ('8-circle-fill-1', '8-circle-fill-1'),
        ('8-circle-fill', '8-circle-fill'),
        ('8-circle', '8-circle'),
        ('8-square-fill', '8-square-fill'),
        ('8-square', '8-square'),
        ('9-circle-1', '9-circle-1'),
        ('9-circle-fill-1', '9-circle-fill-1'),
        ...
        ('c-circle-1', 'c-circle-1'),
        ('c-circle-fill-1', 'c-circle-fill-1'),
        ...
        ('cassette', 'cassette'),
        ('cc-circle-1', 'cc-circle-1'),
        ('cc-circle-fill-1', 'cc-circle-fill-1'),
        ...
        ('h-circle-1', 'h-circle-1'),
        ('h-circle-fill-1', 'h-circle-fill-1'),
        ...
        ('p-circle-1', 'p-circle-1'),
        ('p-circle-fill-1', 'p-circle-fill-1'),
        ...
        ('r-circle-1', 'r-circle-1'),
        ('r-circle-fill-1', 'r-circle-fill-1'),
    ...
    profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE,verbose_name='Profile')
    name = models.CharField(max_length=200, blank=True, null=True,verbose_name='Nom')
    iconeb = models.CharField(
        max_length=50, default='bi-emoji-smile', choices=ICONEB_CHOICES,verbose_name='Icône')
    
    score = models.IntegerField(default=0, blank=True, null=True,verbose_name='Score')
    is_active = models.BooleanField(default=True,verbose_name='Active')
...
class Skill(models.Model):
    class Meta:
        verbose_name_plural = '05.Compétences'
        verbose_name = 'Compétence'

    profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE, verbose_name='Profile')
    name = models.CharField(max_length=20, blank=True, null=True,verbose_name='Nom')
    level = models.IntegerField(default=80, blank=True, null=True,verbose_name='Niveau')

    def __str__(self):
        return self.name

# Resume ===========================================================
class CategoriesResume(models.TextChoices):
    EDU = "Parcour Educationnel"
    PRO = "Parcour Professionel"
    EXP = "Autre Experience"

class Resume(models.Model):

    class Meta:
        verbose_name_plural = '06.CVs'
        verbose_name = 'CV'
        ordering = ["title"]

    profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE, verbose_name='Profile')
    title = models.CharField(max_length=200, blank=True, null=True, verbose_name='Titre')
    category = models.CharField(max_length=50, default='EXP', choices=CategoriesResume.choices,verbose_name='Catégorie')    
    startPeriode = models.DateField(blank=True, null=True,verbose_name='Début')
    endPeriode = models.DateField(blank=True, null=True,verbose_name='Fin')
    place = models.CharField(max_length=200, blank=True, null=True,verbose_name='Place')
...
class Works(models.Model):
    class Meta:
        verbose_name_plural = '07.Travaux'
        verbose_name = 'Travail'
        ordering = ["work"]

    resume = models.ForeignKey(Resume, on_delete=models.CASCADE,verbose_name='Entrée CV')
    work = models.CharField(max_length=500, blank=True, null=True,verbose_name="Travail")
...
class CategoriesPortfolio(models.Model):

    class Meta:
        verbose_name_plural = '08.Catégories de Portfolios'
        verbose_name = 'Catégorie de Portfolio'

    category = models.CharField(max_length=50, verbose_name='Catégorie de portfolio', primary_key=True)
    def __str__(self):
...
class Portfolio(models.Model):
    ...
    class Meta:
        verbose_name_plural = '09.Portfolios'
    ...
    client = models.CharField(max_length=50, blank=True, null=True,verbose_name='Client')
    category = models.ForeignKey(CategoriesPortfolio,to_field= 'category', on_delete=models.SET_DEFAULT, default='Hors Catégorie',verbose_name='Catégorie')
    ...
    def rename_upload_image(instance, filename):
        filebase, extension = filename.split('.')
        return 'portfolio\\'+f'{instance.profile.user.username}'+'\\' +f'{instance.name}'+ '.' + f'{extension}'
    
    image = models.ImageField( upload_to=rename_upload_image)
    ...
    def get_absolute_url(self):       
        return reverse('PortfolioDetailView', args=[str(self.id)])
   
    def __str__(self):
        return f'{self.profile.user.username}' + '_' + f'{self.name}'

    # def get_absolute_url(self):
    #     return f"/portfolio/{self.slug}"

class ScreenShotsPortfolio(models.Model):

    class Meta:
        verbose_name_plural = '10.Captures de Portfolios'
        verbose_name = 'Capture de Portfolio'

    portfolio = models.ForeignKey(Portfolio, on_delete=models.CASCADE, verbose_name='Portfolio')

    def rename_upload_screen_shot(instance, filename):
        filebase, extension = filename.split('.')
        return 'portfolio\\'+f'{instance.portfolio.profile.user.username}'+'\\' +f'{instance.portfolio.name}'+'\\' +f'{datetime.now()}'+ '.' + f'{extension}'
  
    screen_shot = models.ImageField(upload_to=rename_upload_screen_shot, verbose_name='Capture')

    def __str__(self):
        return self.screen_shot.url
...
class Certificate(models.Model):
    ...
    class Meta:
        verbose_name_plural = '11.Certificats'
    ...
    profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE,verbose_name='Profile')
    date = models.DateField(blank=True, null=True,verbose_name='Date')
    organism = models.CharField(max_length=100, blank=True, null=True,verbose_name='Organisme')
    title = models.CharField(max_length=200, blank=True, null=True,verbose_name='Titre')
    link_to_certificat = models.URLField(max_length=200,blank=True, null=True,verbose_name='Lien vers le certificat')
    description = models.CharField(max_length=500, blank=True, null=True,verbose_name='Description')
    is_active = models.BooleanField(default=True,verbose_name='Active')
    color_display = models.CharField(max_length=10, choices=COLOR_CHOICES,verbose_name='Couleur d\'affichage')
...
class Testimonial(models.Model):
    ...
    class Meta:
        verbose_name_plural = '12.Témoignages'
        verbose_name = 'Témoignage'
        ordering = ["name"]

    profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE)
    name = models.CharField(max_length=200,unique=True,verbose_name='Nom')
    role = models.CharField(max_length=200, blank=True, null=True,verbose_name='Rôle')
    quote = models.CharField(max_length=500, blank=True, null=True,verbose_name='Quote')
    is_active = models.BooleanField(default=True,verbose_name='Active')

    def __str__(self):
        return self.name

    def rename_upload_thumbnail(instance, filename):
        filebase, extension = filename.split('.')        
        return 'testimonials\\'+f'{instance.profile.user.username}'+'\\' +f'{instance.name}'+ '.' + f'{extension}'

    thumbnail = models.ImageField(
        blank=True, upload_to=rename_upload_thumbnail, default='testimonials/default_thumbnail.jpg')
...
class Contact(models.Model):
    ...
    class Meta:
        verbose_name_plural = '13.Contactes'
        verbose_name = 'Contacte'
        ordering = ["timestamp"]

    profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE)
    # profile = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE)
    timestamp = models.DateTimeField(auto_now_add=True)
    name = models.CharField(max_length=100,verbose_name='Nom')
    mailadress = models.CharField(max_length=100, blank=True, null=True,verbose_name='Mail')
    subject = models.CharField(max_length=100, blank=True, null=True,verbose_name='Objet')
